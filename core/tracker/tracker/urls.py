...
from .views import (TrackerAPIView, TrackerAppCategoryView,
                    TrackerApplicationGroupsView, TrackerAppsView,
                    TrackerBasicTimeDetailsView, TrackerCategoryBreakDownView,
                    TrackerLiveFeedView, TrackerProductiveBreakDownView,
                    TrackerProductivityStatusView, TrackerSetAppCategoryView,
                    TrackerTimeBarView, TrackerWebsitesVistedView,
